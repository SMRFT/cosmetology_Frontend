...
const BillingProcedureReport = () => {
    ...
    const downloadProcedureCSV = () => {
        ...
        const headers = ['Patient Name', 'Patient UID', 'Consumer Billnumber', 'Appointment Date', 'Procedure', 'Procedure Date', 'Price', 'GST', 'GST Rate', 'Total', 'Branch Code'];
        ...
        try {
            const response = await axios.delete('http://127.0.0.1:8000/delete_procedure_data/', {
                data: {
                    ...
                    branch_code: branchCode // Include branch_code in the delete request
                },
                headers: {
                    'X-Branch-Code': branchCode
                },
