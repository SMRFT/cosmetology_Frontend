...
const PatientForm = ({ patientData, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (patientData) {
      axios
        .patch(`https://api.shinovadatabase.in/Patients_data/${formData.patientUID}/`,  { ...requestData, purposeOfVisit: finalPurposeOfVisit })
        .then(() => {
      ...
      axios.post('https://api.shinovadatabase.in/Patients_data/', { ...requestData, purposeOfVisit: finalPurposeOfVisit })
        .then(() => {
