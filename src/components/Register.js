...
const Register = () => {
 ...
 const Cosmetologybaseurl = process.env.REACT_APP_BACKEND_COSMETOLOGY_BASE_URL
  const [formData, setFormData] = useState({
    ...
    name: "",
    role: "",
    branch_code: [], // Simple array of branch codes
    contact: "",
    password: "",
    confirmPassword: "",
  })
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.checkValidity() === false || formData.branch_code.length === 0) {
      ...
      try {
        // Send branch codes as simple array - no need to convert to objects
        const submitData = {
          ...formData,
        }
              ...
              <Col sm="6">
                <Form.Group controlId="id">
                  ...
                  <Form.Control
                    ...
                    autoComplete="off"
                    isInvalid={
                      (touchedFields.id && !formData.id) || (formData.id && !/^[a-zA-Z0-9]+$/.test(formData.id))
                    }
              ...
              <Col sm="6">
                <Form.Group controlId="name">
                  ...
                  <Form.Control
                    ...
                    pattern="[A-Za-z\s]+"
                    isInvalid={
                      (touchedFields.name && !formData.name) || (formData.name && !/^[A-Za-z\s]+$/.test(formData.name))
                    }
                    style={{ border: "1px solid #DAD1E1" }}
                  />
                  <Form.Control.Feedback type="invalid">
                      ...
                      {branches.map((branch, index) => (
                        ...
                        >
                          <div className="d-flex align-items-center" style={{ gap: "10px" }}>
                            <input type="checkbox" checked={isBranchSelected(branch.branch_code)} onChange={() => {}} />
                ...
                <Form.Group controlId="contact">
                  ...
                  <Form.Control
                    ...
                    isInvalid={
                      ...
                      (!formData.contact || (!isValidEmail(formData.contact) && !isValidPhone(formData.contact)))
                    }
                    autoComplete="off"
                    style={{ border: "1px solid #DAD1E1" }}
                  />
